...
@endif
            ...
            <div class="gg">
                  <form action="{{url('/upload_paddyBugs')}}" method="post" enctype="multipart/form-data">
           @csrf
                  <br><br><br><br><br>
                  <h1 class="text-3xl"><b> Add New Types of Paddy Bugs </b></h1>
                  <br>
                  <table class="table">
                        <tr><td>
                         <div>
      ...
      <input name="article" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Article Name" style="width:80%">
                        ...
                        <tr><td>
                            <label>Bug Name</label></td>
                            <td><div class="mb-4">
      
      <input name="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="title" style="width:80%" required>
    </div>
                         </div>
                         </div></td></tr>
                        ...
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 "></textarea>
                         ...
                         <tr><td><label>Perventation Method</label></td>
                        <td><textarea name="pervent" placeholder="Write Enter the Body Text" rows="3"  cols="2" required
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 "></textarea>
                                                   </div></td></tr>              
                        ...
                        type="submit" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Submit</button>
                         </div></td></tr>
                  </table>
